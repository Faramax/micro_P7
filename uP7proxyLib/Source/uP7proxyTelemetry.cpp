...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool CProxyTelemetry::ExtractStartTime(const stProxyPacket *i_pPackets, uint64_t &io_rStartTime)
{
    LOCK_ENTER(m_hLock);
          ...
          )
    {
        if (uP7packetTelemetryDouble == i_pPackets->pHdr->bType)
        {
            ...
            {
                io_rStartTime = l_pHdrIn->qwTime;
            }
            else
            {
                io_rStartTime = ntohqw(l_pHdrIn->qwTime);
            }
        ...
        else if (uP7packetCreateTimeResponse == i_pPackets->pHdr->bType)
        {
            ...
            if (!m_bConvertEndianess)
            {
                io_rStartTime = l_pHdrIn->qwCpuCurrenTime;
            }
            else
            {
                io_rStartTime = ntohqw(l_pHdrIn->qwCpuCurrenTime);
            }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CProxyTelemetry::SetStartTime(uint64_t i_qwStartTime)
{
    LOCK_ENTER(m_hLock);
